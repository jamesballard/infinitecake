 ...
 */
     ...
     * @return array Academic Year => Period => Count
     */
    function getTaskTypeCount($filter, $interval, $dateFormat) {
        $interval = new DateInterval($interval);
     ...
     * @return array Academic Year => Period => Count
     */
    function getTaskTypeCountGchart($filter, $interval, $dateFormat) {
        $results = $this->getTaskTypeCount($filter, $interval, $dateFormat);
        $data = $this->transformGchartArray($results);
        return $data;
    }
}
