<div class="artefacts index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $artefact['Artefact']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $artefact['Artefact']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $artefact['Artefact']['id']), null, __('Are you sure you want to delete # %s?', $artefact['Artefact']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
