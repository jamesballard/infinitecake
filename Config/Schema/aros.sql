...
insert into `aros` (`id`, `parent_id`, `model`, `foreign_key`, `alias`, `lft`, `rght`) values('4','1','Member','1','Member::','2','3');
insert into `aros` (`id`, `parent_id`, `model`, `foreign_key`, `alias`, `lft`, `rght`) values('5','2','Member','2','Member::Patricia','6','7');
insert into `aros` (`id`, `parent_id`, `model`, `foreign_key`, `alias`, `lft`, `rght`) values('6','2','Member','3','Member::Jonathan P.','8','9');
