<?php
/**
 * FactSummedActionsDateFixture
 *
 */
class FactSummedActionsDateFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'fact_summed_actions_date';
 ...
 */
	public $fields = array(
		...
		'indexes' => array(
			'PRIMARY' => array('column' => array('user_id', 'artefact_id', 'dimension_date_id', 'system_id', 'group_id'), 'unique' => 1),
